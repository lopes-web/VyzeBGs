            ...
            <div className="flex-grow flex flex-col items-center justify-center p-4 z-10 -mt-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-3xl w-full mb-12">
                    ...
                    <button
                        ...
                        className="group relative overflow-hidden bg-black/40 backdrop-blur-xl border border-white/10 rounded-2xl p-6 text-left hover:border-lime-500/50 transition-all duration-300 hover:shadow-xl hover:shadow-lime-500/5"
                    >
                    ...
                    <button
                        ...
                        className="group relative overflow-hidden bg-black/40 backdrop-blur-xl border border-white/10 rounded-2xl p-6 text-left hover:border-purple-500/50 transition-all duration-300 hover:shadow-xl hover:shadow-purple-500/5"
                    >
