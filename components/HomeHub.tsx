            ...
            <div className="relative z-10 flex-grow flex flex-col items-center justify-center p-4 -mt-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-3xl w-full mb-12 animate-fadeInUp delay-100 opacity-0" style={{ animationFillMode: 'forwards' }}>
                    ...
                    <button
                        ...
                        className="group relative overflow-hidden bg-black/30 backdrop-blur-3xl border border-white/10 rounded-2xl p-6 text-left hover:border-lime-500/50 transition-all duration-300 hover:shadow-xl hover:shadow-lime-500/5"
                    >
                        ...
                        <div className="flex items-start justify-between mb-4">
                            <div className="p-3 bg-lime-500/10 rounded-xl text-lime-400 group-hover:bg-lime-500 group-hover:text-black transition-colors">
                                <i className="fas fa-laptop-code text-xl"></i>
                            </div>
                            <i className="fas fa-arrow-right text-gray-700 group-hover:text-lime-500 transition-colors -translate-x-2 opacity-0 group-hover:opacity-100 group-hover:translate-x-0"></i>
                        </div>
                        <h3 className="text-lg font-bold mb-1 text-white">Landing Pages</h3>
                    ...
                    <button
                        ...
                        className="group relative overflow-hidden bg-black/30 backdrop-blur-3xl border border-white/10 rounded-2xl p-6 text-left hover:border-purple-500/50 transition-all duration-300 hover:shadow-xl hover:shadow-purple-500/5"
                    >
                        ...
                        <div className="flex items-start justify-between mb-4">
                            ...
                            <i className="fas fa-arrow-right text-gray-700 group-hover:text-purple-500 transition-colors -translate-x-2 opacity-0 group-hover:opacity-100 group-hover:translate-x-0"></i>
                        </div>
                    ...
                    <div className="relative group">
                        <div className="relative bg-black/60 backdrop-blur-2xl rounded-2xl flex items-center p-2 shadow-2xl border border-white/10">
                            ...
                            <div className="relative">
                                ...
                                {isDropdownOpen && (
                                    <div
                                        className="absolute top-full left-0 mt-2 w-48 bg-black/30 backdrop-blur-3xl border border-white/10 rounded-xl shadow-xl overflow-hidden py-1 z-50 animate-in fade-in zoom-in-95 duration-200"
                                    >
                                        <button
                            ...
                            <div className="relative">
                                ...
                                {isConfigOpen && (
                                    <div
                                        className="absolute bottom-full left-0 mb-4 w-80 bg-black/30 backdrop-blur-3xl border border-white/10 rounded-2xl shadow-2xl p-4 z-50 animate-in fade-in zoom-in-95 duration-200 max-h-[500px] overflow-y-auto"
                                    >
