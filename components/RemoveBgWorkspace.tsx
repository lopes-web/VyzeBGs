...
const RemoveBgWorkspace: React.FC<RemoveBgWorkspaceProps> = ({ onBack }) => {
    ...
    return (
        <div className="flex flex-col h-screen bg-neutral-50 dark:bg-neutral-950 relative overflow-hidden font-sans">
            {/* Top Bar - Simplified */}
            <div className="flex-none p-4 flex items-center z-20 bg-white/50 dark:bg-neutral-900/50 backdrop-blur-sm border-b border-neutral-200/50 dark:border-neutral-800/50">
                <button
                    onClick={onBack}
                    className="w-10 h-10 rounded-xl bg-white dark:bg-neutral-800 flex items-center justify-center text-neutral-900 dark:text-white hover:bg-neutral-100 dark:hover:bg-neutral-700 transition-colors shadow-sm border border-neutral-200 dark:border-neutral-700 mr-4"
                >
                ...
                <div className="relative z-10 w-full max-w-6xl h-full flex flex-col items-center justify-center">
                    ...
                    {!inputImage ? (
                        <div className="max-w-xl w-full animate-fadeIn">
                            ...
                            <div className="bg-white/60 dark:bg-neutral-900/60 backdrop-blur-xl border border-neutral-200 dark:border-neutral-800 rounded-3xl p-8 shadow-2xl">
                                <ImageUpload
                                    label=""
                                    value={null}
                                    onChange={(val) => {
                        ...
                        <div className="w-full h-full flex flex-col items-center justify-center gap-6 animate-fadeIn">
                            ...
                            <div className="relative w-full max-w-5xl aspect-video bg-white/60 dark:bg-neutral-900/60 backdrop-blur-xl border border-neutral-200 dark:border-neutral-800 rounded-3xl shadow-2xl overflow-hidden flex items-center justify-center p-8">
                            ...
                            {/* Toolbar */}
                            <div className="flex items-center gap-4 bg-white/80 dark:bg-neutral-900/80 backdrop-blur-xl p-2 rounded-2xl border border-neutral-200 dark:border-neutral-800 shadow-xl">
                                <button
                                    onClick={handleReset}
                                    className="px-6 py-3 rounded-xl bg-neutral-100 dark:bg-neutral-800 text-neutral-600 dark:text-neutral-300 font-medium hover:bg-red-50 dark:hover:bg-red-900/20 hover:text-red-500 transition-colors flex items-center gap-2"
                                >
